        ...
        <div className='bg-gray-800 py-8 px-4 shadow sm:rounded-lg sm:px-10'>
          <form onSubmit={handleSubmit} className='space-y-6'>
            ...
            <div>
              ...
              <div className='mt-1 relative rounded-md shadow-sm'>
                <div className='text-white absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none'>
            ...
            <div>
              ...
              <div className='mt-1 relative rounded-md shadow-sm'>
                ...
                <input
                  ...
                  className='text-white block w-full px-3 py-2 pl-10 bg-gray-700 border
